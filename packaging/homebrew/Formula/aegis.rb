class Aegis < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/IliasAlmerekov/aegis/releases/download/v0.5.6/aegis-macos-aarch64", using: :nounzip
      sha256 "8768865f2456c115788967ab29db790106e8a87fea8aa654561f8e942ec172b0"
    else
      url "https://github.com/IliasAlmerekov/aegis/releases/download/v0.5.6/aegis-macos-x86_64", using: :nounzip
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/IliasAlmerekov/aegis/releases/download/v0.5.6/aegis-linux-aarch64", using: :nounzip
      sha256 "5e900632230750dff271d5816bd7c81a53158005d88c30ec439e59df871d0e31"
    else
      url "https://github.com/IliasAlmerekov/aegis/releases/download/v0.5.6/aegis-linux-x86_64", using: :nounzip
